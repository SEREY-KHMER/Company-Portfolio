    ...
    <footer className="bg-[#1c1814] text-orange-50/95">
      <Container className="py-12 sm:py-14">
        <div className="flex flex-col gap-10 lg:flex-row lg:justify-between">
          <div>
            <p className="font-en text-xl font-semibold text-orange-100">SEREY KHMER</p>
            <nav className="mt-6 flex flex-wrap gap-x-6 gap-y-3 text-sm text-orange-100/85">
        ...
        <p className="mt-10 border-t border-orange-100/10 pt-8 text-center text-xs text-orange-200/70 sm:text-sm">
